...
# 用法: sudo bash /opt/axmipusher-src/deploy/cloud-build-deploy.sh
...
sudo systemctl stop axmipusher
...
echo "[5/5] 重启并验证..."
sudo systemctl start axmipusher
sleep 3
sudo systemctl is-active axmipusher
